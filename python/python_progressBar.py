...
if __name__ == "__main__":
    ...
    # Calibrate the maximum value the progress bar should get/expect
    maxValue=os.path.getsize(localFileName)
    # Function returns a progress bar object (pBar) and a CallBack(int, int) function
    pBar, CallBack = mf.StartProgressBar(maxValue)
    sftp.put(localFileName, remoteFileName, callback=CallBack)
